...
base_url = "https://www.metacritic.com/browse/game/ps5/all/all-time/metascore/?releaseYearMin=1958&releaseYearMax=2025&platform=ps5&page="
...
# Save to CSV
df.to_csv("metacritic_games_ps5.csv", index=False)